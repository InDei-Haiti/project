              ...
              <article class="article col-md-12">
                <div class="inner">
                  ...
                  <div class="padding">
                    ...
                    <h2><a href="/single">Exercitation ullamco laboris nisi ut aliquip</a></h2>
            ...
            <div class="row">
              <article class="article col-md-12">
                <div class="inner">
                  ...
                  <div class="padding">
                    <div class="detail">
                      <div class="time">12-р сарын 09, 2018</div>
                      <div class="category"><a href="category">Улс төр</a></div>
                    </div>
                    <h2><a href="/single">Mauris elementum libero at pharetra auctor</a></h2>
                ...
                <div class="inner">
                  ...
                  <div class="padding">
                    <div class="detail">
                      ...
                      <div class="category"><a href="category">Спорт</a></div>
                    </div>
                    <h2><a href="/single">Sed do eiusmod tempor incididunt ut labore</a></h2>
    ...
    <div class="owl-carousel owl-theme carousel-1">
      <article class="article">
        <div class="inner">
          ...
          <div class="padding">
            <div class="detail">
                <div class="time">12-р сарын 11, 2018</div>
                <div class="category"><a href="category">Аялал</a></div>
            </div>
            <h2><a href="/single">tempor interdum Praesent tincidunt</a></h2>
      ...
      <article class="article">
        <div class="inner">
          ...
          <div class="padding">
            ...
            <h2><a href="/single">Maecenas porttitor sit amet turpis a semper</a></h2>
      ...
      <article class="article">
        <div class="inner">
          ...
          <div class="padding">
            ...
            <h2><a href="/single">Fusce ac odio eu ex volutpat pellentesque</a></h2>
      ...
      <article class="article">
        <div class="inner">
          ...
          <div class="padding">
            ...
            <h2><a href="/single">Nulla facilisis odio quis gravida vestibulum</a></h2>
      ...
      <article class="article">
        <div class="inner">
          ...
          <div class="padding">
            ...
            <h2><a href="/single">Fusce Ullamcorper Elit At Felis Cursus Suscipit</a></h2>
            <p>Proin venenatis pellentesque arcu, ut mattis nulla placerat et.</p>
          </div>
        </div>
      </article>
      <article class="article">
        <div class="inner">
          ...
          <div class="padding">
            ...
            <h2><a href="/single">Donec consequat arcu at ultrices sodales</a></h2>
            <p>Proin venenatis pellentesque arcu, ut mattis nulla placerat et.</p>
          </div>
        </div>
      </article>
